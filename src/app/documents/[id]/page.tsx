...
export default function DocumentViewPage({
  ...
  const convertToInvoice = async () => {
    ...
    try {
      const response = await fetch(
        `/api/documents/${params.id}/convert-to-invoice`,
        {
          method: "POST",
        }
      );
  ...
  if (!document) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-xl text-gray-600">{t("view.notFound")}</div>
      </div>
    );
  }
            ...
            {document.type === "invoice" &&
              ...
              document.quote_document_id && (
                <p className="mt-1 print:text-sm font-medium">
                  ...
                  >
                    {t("view.quote")} {document.quote_number}
                  </Link>
                </p>
              )}
            <p className="text-gray-600 mt-2 print:mt-1 print:text-sm">
              {t("view.createdOn", { document: document.type })}{" "}
          ...
          <div className="flex gap-3 items-center print:hidden">
            {document.type === "quote" &&
              (document.invoice_number && document.invoice_document_id ? (
                ...
                >
                  {t("view.viewInvoice")} {document.invoice_number}
                </Link>
              ) : (
                <button
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 print:p-0 print:shadow-none print:flex-1 print:flex print:flex-col">
          <div className="print:flex-1">
            ...
            <div className="mb-8 print:mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 print:mb-3">
                {t("view.services")}
              </h3>
            ...
            <div className="border-t border-gray-200 pt-6 print:pt-4">
              <div className="max-w-md ml-auto space-y-2">
                ...
                <div className="flex justify-between text-base">
                  <span className="font-medium text-gray-700">
                    {t("view.vat")} ({(document.vat_rate * 100).toFixed(0)}%):
                  </span>
                  <span className="text-gray-900">
                    €{document.vat_amount.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between text-lg font-bold border-t border-gray-200 pt-2">
                  <span className="text-gray-900">{t("view.total")}:</span>
                  <span className="text-gray-900">
